...
function TroubleShoot({ isOpen, setIsOpen, userData, actionMessage }) {
    ...
    try {
      ...
      if (response?.status === 200) {
        try {
          ...
          toastManager.success("Your problem has been fixed!");
        } catch (cacheError) {
          ...
          <div className="p-8">
            {isSubmitted ? (
              <div className="flex flex-col items-center justify-center py-6 text-center">
                ...
                <p className="text-gray-800 text-lg font-medium">Your request has been confirmed successfully!</p>
                <p className="text-gray-500 mt-2">The system has been refreshed.</p>
              </div>
            ) : (
              <div className="space-y-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm">
                    This action will clear all caches and refresh the system.
                  </p>
                </div>
