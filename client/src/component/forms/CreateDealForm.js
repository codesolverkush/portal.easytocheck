...
export default function CreateDealForm() {
        ...
        <div key={field.api_name} className="mb-3 relative suggestions-container">
          ...
          <div className="flex">
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-l-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            />
            <button
              type="button"
            ...
            <div className="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base overflow-auto focus:outline-none sm:text-sm">
              {isSearching ? (
                ...
                suggestions.map((item) => (
                  ...
                  >
                    <div className="font-medium">{item.Full_Name || item.Account_Name}</div>
  ...
  const LoadingSpinner = () => (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-indigo-50 to-blue-50">
      ...
      <p className="text-indigo-800 mt-4 text-lg font-medium">Loading Deal Form...</p>
    </div>
  );
...
//       // Also add the IDs for contact and account if available
//       if (formData.contact_id) {
//         formattedData.contact_id = formData.contact_id;
//       }
      
//       if (formData.account_id) {
//         formattedData.account_id = formData.account_id;
//       }
...
//         // Clear deal cache to ensure fresh data is fetched next time
//         try {
//           const cache = await caches.open(CACHE_NAME);
...
//           <h2 className="text-2xl font-bold mb-4 text-center">Create a New Deal</h2>
