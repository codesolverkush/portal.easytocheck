        ...
        field.pick_list_values?.length > 0 ? (
          ...
          <div className="flex items-center">
            <input
              ...
              onChange={handleChange}
              className={`h-4 w-4 ${focus.text} ${focus.ring} border-gray-300 rounded`}
            />
            <label
          ...
          <input
            ...
            className={`w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 ${focus.border} ${focus.border}`}
          />
        )}
      </div>
    );
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex justify-end space-x-4 mt-8 pt-4 border-t border-gray-200">
                    <button
                      ...
                      className="px-5 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-800"
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      className={`px-5 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${bgColors.primary} ${hoverColors.primary} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-800 flex items-center`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
