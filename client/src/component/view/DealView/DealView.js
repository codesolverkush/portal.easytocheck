...
const DealView = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Quick details modal for mobile */}
      {selectedDeal && (
...
//                 {accessScore < 2 ? (
//                  <button
//                     onClick={() => toast.error("Insufficient access rights to create a deal")}
//                     className="flex-1 sm:flex-none bg-blue-500 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors text-sm md:text-base opacity-50 cursor-not-allowed"
//                   >
//                     <Plus size={16} className="mr-1 md:mr-2" />
//                     <span className="hidden sm:inline">Create Deal</span>
...
//                       <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${sourceColors[selectedDeal.Stage] || "bg-gray-200 text-gray-700"}`}>
//                         {selectedDeal.Stage || '-'}
//                       </span>
//                     </div>

//                     <div>
//                       <span className="block text-xs font-medium text-gray-500">PIPELINE</span>
//                       <span className="text-sm">{selectedDeal.Pipeline || '-'}</span>
//                     </div>

//                     <div>
//                       <span className="block text-xs font-medium text-gray-500">CREATED</span>
//                       <span className="text-sm">{moment(selectedDeal.Created_Time).format("DD-MM-YY HH:mm") || "-"}</span>
//                     </div>
//               </div>
//               </div>
//           </div>
