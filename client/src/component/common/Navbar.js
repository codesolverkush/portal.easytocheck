...
const Navbar = ({ accessData }) => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-2">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              {/* Use the new CompanyLogo component */}
              <CompanyLogo />
            </div>
        ...
        >
          <div className="flex flex-col h-full">
            <div className="p-4 border-b">
              {/* Use the new CompanyLogo component in sidebar */}
              <CompanyLogo />
            </div>
      ...
      {/* Support Popup - It will handle its own visibility */}
      <SupportPopup
...
// Updated NavLink component that checks if the link is active
const NavLink = ({ to, icon, text, currentPath, state }) => {
  ...
  return (
    ...
    >
      <span className={`text-xl mr-2 ${isActive ? "text-blue-600" : ""}`}>{icon}</span>
      <span>{text}</span>
    </Link>
  );
};

// Updated SidebarLink component that checks if the link is active
  ...
  return (
    ...
    >
      <div className="flex items-center">
        <span className={`text-xl mr-3 ${isActive ? "text-blue-600" : "text-gray-500"}`}>{icon}</span>
...
//       <div className="w-10 h-10 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-lg flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300 transform group-hover:scale-105">
//         <Globe className="text-white h-6 w-6" strokeWidth={2} />
//       </div>
...
//           Easy Portal
//         </span>
//         <span className="text-xs text-gray-500 -mt-1">Business Solutions</span>
//       </div>
//     </Link>
//   );
// };
...
//                 <div className="w-10 h-10 bg-gradient-to-br from-indigo-800 to-purple-600 rounded-xl flex items-center justify-center shadow-lg transform hover:rotate-6 transition-transform duration-300">
//                   <Globe className="text-white" size={28} />
//                 </div>
//                 <h4 className="text-3xl inline font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-800 to-purple-800">
//                   Easy Portal
//                 </h4>
//               </div>
//             </div>
...
// //                 text="Contacts"
// //               />
// //               <NavLink to="/app/dealView" icon={<Handshake />} text="Deals" />
// //               <NavLink
// //                 to="/app/meetingView"
// //                 icon={<MdEvent />}
// //                 text="Meetings"
