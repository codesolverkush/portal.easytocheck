...
const Organization = () => {
  ...
  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
    ...
    <Link
      to="/app/imfromzoho"
      className={`${bgColors.primary} text-white ${hoverColors.primary} rounded-md px-4 py-2 font-medium hover:bg-blue-50 shadow-sm border border-blue-200 transition duration-300 flex items-center justify-center`}
    >
