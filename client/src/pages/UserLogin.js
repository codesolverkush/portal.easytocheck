...
import { userExists, setCookies, setOrgId, setLicenseStatus,setSuperAdminStatus } from "../redux/reducers/auth";
      ...
      try {
        ...
        if (response.status === 200) {
          ...
          if (response2.status === 200) {
            ...
            const isSuperAdmin = response2?.data?.isSuperAdmin;
...
//             if (active && response2.status !== 202) {
//               navigate("/app/home", { state: { orgId } });
//               toast.success(`Greeting from ${displayname}`);
//             } else if(active && response2.status === 202){
//               navigate("/app/orgprofile")
//             } else{
//               navigate("/app/license");
//               toast.error("Your license has expired!");
